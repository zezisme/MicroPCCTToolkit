...
path1 = [savepath,'\',char(MaterialNames(1)),'_',char(MaterialNames(2)),'\',char(MaterialNames(1))];
path2 = [savepath,'\',char(MaterialNames(1)),'_',char(MaterialNames(2)),'\',char(MaterialNames(2))];
